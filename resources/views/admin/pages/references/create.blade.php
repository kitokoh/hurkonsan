            ...
            <div class="col-lg-7 layout-spacing">
                <div class="statbox widget box box-shadow">
                    ...
                    <div class="widget-content widget-content-area">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form action="{{ route('references.store') }}" method="post" id="mainForm" enctype="multipart/form-data">@csrf
                                    ...
                                    <div class="form-group">
                                        <p>Referans URL</p>
                                        <input id="t-text" type="text" name="reference_url" class="form-control @error('url') is-invalid @enderror">
                                        @error('url')
                                        <div class="alert alert-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="col-lg-12 col-12 ">
                                <div class="custom-file-container" data-upload-id="myFirstImage">
                                    ...
                                    <label class="custom-file-container__custom-file" >
                                        <input type="file" form="mainForm" name="image" class="custom-file-container__custom-file__custom-file-input" accept="image/*" required>

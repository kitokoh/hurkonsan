                    ...
                    <table id="zero-config" class="table dt-table-hover" style="width:100%;padding: 15px">
                        ...
                        @foreach($references as $key => $reference)
                            <tr>
                                ...
                                <td>{{ $reference->reference_url }}</td>
                                <td>
                                    <a href="{{ route('references.edit',$reference->id) }}"><i style="color: cornflowerblue" class="far fa-edit fa-2x"></i>  </a>
                                    <a href="#"
                                    ...
                                    <form id="deleteform{{ $key }}" method="POST" action="{{ route('references.destroy',$reference->id) }}">@method('DELETE')@csrf</form>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>

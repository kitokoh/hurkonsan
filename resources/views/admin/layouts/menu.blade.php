...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            {{--  Referans Yönetimi  --}}
            <li class="menu">
                <a href="#ref" data-active="false" data-toggle="collapse" aria-expanded="false"
                   class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled" id="ref" data-parent="#accordionExample">
                    <li class="active">
            ...
            {{--  Müşteri Yorum Yönetimi  --}}
            <li class="menu">
                <a href="#customersReview" data-active="false" data-toggle="collapse" aria-expanded="false"
                   class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <ul class="collapse submenu list-unstyled" id="customersReview" data-parent="#accordionExample">
                    <li class="active">
                        <a href="{{ route('review.index') }}"> Müşteri Yorumları </a>
                    </li>
                    <li>
                        <a href="{{ route('review.create') }}"> Müştreri Yorum Ekle </a>
                    </li>
                </ul>
            </li>
            ...
            {{-- Ürün Yönetimi --}}
            <li class="menu">
                <a href="#products" data-active="false" data-toggle="collapse" aria-expanded="false"
                   class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            {{--Kategori Yönetimi--}}
            <li class="menu">
                <a href="#categories" data-active="false" data-toggle="collapse" aria-expanded="false"
                   class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            {{-- Genel Ayarları --}}
            <li class="menu">
                <a href="{{ route('catalog.index') }}" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                             fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                             stroke-linejoin="round" class="feather feather-home">
